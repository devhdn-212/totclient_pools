...
type CompanyconftotoData struct {
	IDcompconftoto          string          `json:"idcompconftoto"`
	...
	CreateAt                time.Time       `json:"companyconftoto_create_at"`
	UpdateBy                string          `json:"companyconftoto_update_by"`
	UpdateAt                time.Time       `json:"companyconftoto_update_at"`
}

type CompanyconftotoSaveAngka struct {
...
type CompanyconftotoSaveColokrtttttttttttttfrfrfrfrfrfrfrfrfr struct {
	Type                    string          `json:"type" validate:"required"`
	IDcompconftoto          string          `json:"idcompconftoto"`
	IDcompany               string          `json:"idcompany"  validate:"required"`
	AngkaMaxMinbasket       decimal.Decimal `json:"companyconftoto_angka_max_minbasket"`
